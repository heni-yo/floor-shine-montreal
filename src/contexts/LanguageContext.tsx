...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'form.areaHelper': 'Largeur x Longueur en pied = le nombre de pied carré',
  ...
  en: {
    ...
    'form.areaHelper': 'Width x Length in feet = square footage',
    'form.wantColor': 'Do you want to add color to your floor?',
    'form.colorYes': 'Yes',
    'form.colorNo': 'No',
    'form.stairSteps': 'Please indicate the number of stair treads',
    'form.stairStepsHelper': '*If Stairs',
